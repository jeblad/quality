...
use Quality\Feature\OutputTextLengthFeature;

/**
 * Test Quality\Feature\OutputTextLengthFeature.
 *
 * @file
 * @since 0.1
 *
 ...
 *
 */
class OutputTextLengthFeatureTest extends \MediaWikiTestCase {

	/**
	 * @dataProvider provideBuildRepresentation
	 */
	public function testBuildRepresentation( $params, $opts, $expect ) {
		$feature = new \Quality\Feature\OutputTextLengthFeature( $opts );
