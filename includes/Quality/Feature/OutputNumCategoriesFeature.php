...
/**
 * Feature extractor for number of external links from parser output.
 *
 ...
 */
class OutputNumCategoriesFeature extends OutputFeature {
	...
	public function buildRepresentation( array &$params ) {
		...
		$filter = function( $sortkey ) { return true; };
		...
		$sparse->on( count( array_filter( array_values( $categories ), $filter ) ) );
